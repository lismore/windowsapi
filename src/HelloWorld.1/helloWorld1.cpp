...
const char g_class_name[] = "myHelloWorldWindowClass";
...
int WINAPI WinMain(HINSTANCE hThisInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    WNDCLASSEX wc;
	   ...
	   hwnd = CreateWindowEx(
	      ...
	      g_class_name,
	      "Hello World 1",                 // text appearing in top bar
	      WS_OVERLAPPEDWINDOW,
 ...
 */
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
// This function repeatedly called by WinMain. It receives and reacts to messages.
// hwnd is the window,
